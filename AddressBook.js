...
{
    try{
        let contact = new AddressBook("Dinesh", "Chowdary", "TechCity", "Hyderabad", "Telangana", "542004", "9812287593", "dinesh9@gmail.com");
    }catch (error) {
        console.error(error);
    }
}   

{
    ...
    AddressBookArray.push(new AddressBook("Nethaji", "Chowdary", "Kukatpally", "Hyderabad", "Telangana", "524894", "8596486541", "nethaji123@gmail.com"));
    AddressBookArray.push(new AddressBook("Dinesh", "Chowdary", "TechCity", "Hyderabad", "Telangana", "542004", "9812287593", "dinesh9@gmail.com"));
    ...
    //DuplicateEntry
    {
        let newContact = new AddressBook("Dinesh", "Chowdary", "TechCity", "Hyderabad", "Telangana", "542004", "9812287593", "dinesh9@gmail.com") ;
    ...
    //searchperson
    {
        ...
        let searchPersonInCityOrState = AddressBookArray.filter(contact => contact.firstName == 'Nethaji' && contact.city == givenCity );
